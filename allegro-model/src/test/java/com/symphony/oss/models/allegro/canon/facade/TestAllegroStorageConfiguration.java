...
public class TestAllegroStorageConfiguration
{
  @Test
  public void testRedact()
  {
    IAllegroStorageConfiguration config = new AllegroStorageConfiguration.Builder()
    ...
    assertEquals("{\n" + 
        "  \"_type\":\"com.symphony.s2.model.allegro.AllegroStorageConfiguration\",\n" + 
        "  \"_version\":\"1.0\",\n" + 
    ...
    config = new AllegroStorageConfiguration.Builder()
        .withDefaultConnectionSettings(new ConnectionSettings.Builder()
            .withSslTrustStrategy(SslTrustStrategy.TRUST_ALL_CERTS)
    ...
    System.out.println(config.getRedacted());
